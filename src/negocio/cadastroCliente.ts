...
export default class CadastroCliente extends Cadastro {
    ...
    public preCadastrados(): void {
        let clientesIniciais = [
            ...
            { nome: 'Patrícia Santos', nomeSocial: 'Patrícia', cpf: '222.333.444-56', telefone: '011 11223344', genero: 'F' },
            { nome: 'Anderson Lima', nomeSocial: 'Anderson', cpf: '444.555.666-78', telefone: '032 99887766', genero: 'M' },
            { nome: 'Camila Oliveira', nomeSocial: 'Camila', cpf: '222.333.444-57', telefone: '011 98765432', genero: 'F' },
            { nome: 'Daniel Costa', nomeSocial: 'Daniel', cpf: '888.777.666-58', telefone: '021 99887766', genero: 'M' },
            { nome: 'Aline Martins', nomeSocial: 'Aline', cpf: '111.222.333-59', telefone: '015 12344321', genero: 'F' },
            { nome: 'Marcelo Almeida', nomeSocial: 'Marcelo', cpf: '666.777.888-60', telefone: '011 99887766', genero: 'M' },
            { nome: 'Carolina Lima', nomeSocial: 'Carolina', cpf: '555.444.333-61', telefone: '021 12345678', genero: 'F' },
            { nome: 'Diego Fernandes', nomeSocial: 'Diego', cpf: '333.222.111-62', telefone: '022 87654321', genero: 'M' },
            { nome: 'Luana Santos', nomeSocial: 'Luana', cpf: '999.888.777-63', telefone: '031 11223344', genero: 'F' },
            { nome: 'Marcos Lima', nomeSocial: 'Marcos', cpf: '444.555.666-64', telefone: '015 99887766', genero: 'M' },
            { nome: 'Natália Oliveira', nomeSocial: 'Natália', cpf: '222.333.444-65', telefone: '041 98765432', genero: 'F' },
            { nome: 'Ricardo Costa', nomeSocial: 'Ricardo', cpf: '888.777.666-66', telefone: '011 99887766', genero: 'M' },
            { nome: 'Sandra Martins', nomeSocial: 'Sandra', cpf: '111.222.333-67', telefone: '021 12344321', genero: 'F' },
            { nome: 'Thiago Almeida', nomeSocial: 'Thiago', cpf: '666.777.888-68', telefone: '015 99887766', genero: 'M' },
            { nome: 'Vanessa Lima', nomeSocial: 'Vanessa', cpf: '555.444.333-69', telefone: '021 12345678', genero: 'F' },
            { nome: 'Wagner Fernandes', nomeSocial: 'Wagner', cpf: '333.222.111-70', telefone: '022 87654321', genero: 'M' },
            { nome: 'Yasmin Santos', nomeSocial: 'Yasmin', cpf: '999.888.777-71', telefone: '031 11223344', genero: 'F' },
            { nome: 'Zé Carlos Lima', nomeSocial: 'Zé Carlos', cpf: '444.555.666-72', telefone: '015 99887766', genero: 'M' }
        ];
